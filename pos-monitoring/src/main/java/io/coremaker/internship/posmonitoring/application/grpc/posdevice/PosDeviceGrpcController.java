...
public class PosDeviceGrpcController extends PosDeviceServiceGrpc.PosDeviceServiceImplBase {
    ...
    @Override
    public void updatePosDevice(UpdatePosDeviceStatusRequest.UpdatePosDeviceRequestGrpc request, StreamObserver<UpdatePosDeviceStatusResponse.UpdatePosDeviceResponseGrpc> responseObserver) {
        ...
        UpdatePosDeviceStatusResponse.UpdatePosDeviceResponseGrpc response = UpdatePosDeviceStatusResponse.UpdatePosDeviceResponseGrpc.newBuilder()
                .setId(updatedPosDevice.getId())
                .setDeviceId(updatedPosDevice.getDeviceId())
                .setLocation(updatedPosDevice.getLocation())
                .setProvider(updatedPosDevice.getProvider())
                .setOnline(updatedPosDevice.getOnline())
                .setLastActivity(updatedPosDevice.getLastActivity().toString())
                .setCreatedAt(updatedPosDevice.getCreatedAt().toString())
                .setUpdatedAt(updatedPosDevice.getUpdatedAt().toString())
                .build();
